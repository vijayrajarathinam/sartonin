...
const employeeData = [
...

  {
    id: 3,
    name: "0xacB4....9E69a4",
    position: "Strategy's to distributed systems",
    transactions: 2600,
    rise: true,
    tasksCompleted: 1,
    imgId: 3,
...
const Countrydata = [
  { name: "0x023e....5DbC85", rise: true, value: 21942.83, id: 1 },
  { name: "0x357E....0969CB", rise: false, value: 19710.0, id: 2 },
  { name: "0x9c51....6E1a7a", rise: false, value: 12320.3, id: 3 },
  { name: "0x023d....E1bB82", rise: true, value: 9725.0, id: 4 },
];
...
const sidebarItems = [
  [
    ...
    { id: "2", title: "Learners", notifications: false },
    { id: "3", title: "Comments", notifications: 6 },
  ],
  [
    { id: "4", title: "Payment", notifications: false },
    { id: "5", title: "Upcoming Activities", notifications: false },
    ...
    >
      <div className="flex-shrink-0 overflow-hidden p-2">
        <div className="flex items-center h-full sm:justify-center xl:justify-start p-2 sidebar-separator-top">
          <div className="block sm:hidden xl:block ml-2 font-bold text-xl text-white">Melonin</div>
      ...
      <div className="flex-shrink-0 overflow-hidden p-2">
        <div className="flex items-center h-full sm:justify-center xl:justify-start p-2 sidebar-separator-bottom">
          <Image src="Jerry Wilson" className="w-10 h-10" />
      ...
      <div className="rounded-lg bg-card flex justify-between p-3 h-32">
        <div className="">
          <div className="flex items-center">
            <Image src={name} className="w-10 h-10" />
            <div className="ml-2">
              <div className="flex items-center">
          ...
          <div className="text-sm  mt-2">{`${tasksCompleted} from 5 topics completed`}</div>
...
function Graph() {
  ...
  return (
    <div className="flex p-4 h-full flex-col">
      <div className="">
        <div className="flex items-center">
          <div className="font-bold text-white">Your Course Summary</div>
          <div className="flex-grow" />
  ...
  return (
    <div className="flex p-4 flex-col h-full">
      <div className="flex justify-between items-center">
        <div className="text-white font-bold">Top Learners</div>
      </div>
      {Countrydata.map(({ name, rise, value, id }) => (
        <div className="flex items-center mt-3" key={id}>
          <div className="">{id}</div>

          <Image src={name} className=" w-6 h-6" parentClassName="ml-1 w-7 h-7" />
...
function Image({ src, className = "w-4 h-4", parentClassName = "w-11 h-11" }) {
  return (
    <div className={clsx(parentClassName, "lg:mx-auto border-pink-500 border-2 rounded-full")}>
      <img
        src={`https://avatars.dicebear.com/api/pixel-art/${src}.svg`}
        alt=""
