...
function List() {
  return (
    <div className="mt-10 bg-white  p-10">
      <h3 className="font-bold text-3xl text-gray-800 mb-3">Trending on the platform</h3>

      <p className="md:pr-12 mb-5">
        Expand your career opportunities with Sartonin. Take one of Udemy’s range of Python courses and learn how to
        code using this incredibly useful language. Its simple syntax and readability makes Python perfect for Flask,
        Django, data science, and machine learning. You’ll learn how to build everything from games to sites to apps.
